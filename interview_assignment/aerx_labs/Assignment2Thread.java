...
public class Assignment2Thread {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Assignment2Thread assignment2Thread = new Assignment2Thread();
		assignment2Thread.find_missing_number(array);
	}
	private void find_missing_number(int[] array) throws InterruptedException {
		...
		Thread t1 = new Thread(()->{
			...
			for(int i=1;i<=25;i++) {count=0;
				...
				}if(count==0) {System.out.println("Missing Number is "+i);return;}
			}
		});
